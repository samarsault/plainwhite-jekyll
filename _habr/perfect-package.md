...
За время подготовки этой статьи была выпущена новыя версия pytest, в которой, по факту, дропнули поддержку python 3.4 (на самом деле в пакете [colorama](https://github.com/tartley/colorama)). Вариантов было два:
* зафиксировать версию pytest, совместимую с 3.4;
* дропнуть поддержку 3.4 :)
Я пошел по простому пути, и дропнул ее.
