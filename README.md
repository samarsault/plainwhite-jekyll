...
For more information on Latex syntax, please have a look on this [link](https://www.overleaf.com/learn/latex/Main_Page). Demo for latex mode is included in a default blog post named *"Demo Blog For Latex"*
